...
image:https://ci.appveyor.com/api/projects/status/github/EcoNum/EN-test?branch=master&svg=true["Win Build Status",
link="http://ci.appveyor.com/project/EcoNum/EN-Test"]
image:https://img.shields.io/codecov/c/github/EcoNum/EN-Test/master.svg["Coverage Status", link="https://codecov.io/github/phgrosjean/aurelhy?branch=master"]
