...
## oldIds <- c("R1Is0", "R4Is0", "A1Ia1", "A2IIa4", "B3IIIs5", "C4IVs2", "B1Va2", "C4VIs6")
## checkId(oldIds)
## newIds <- c("A0a00s", "D0a00s", "A1a01a", "B1b04a", "C2c05s", "D3d02s", "A2e02a", "D3f06s")
## checkId(newIds)
...
#' Get the type (addition or sampling)
typeId <- function (Ids)
